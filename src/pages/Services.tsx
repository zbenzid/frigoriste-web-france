        ...
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            <div className="relative z-10 py-12 md:py-0">
              ...
              <h1 className="text-4xl font-bold text-gray-800 mb-6 font-montserrat md:text-3xl">Nos solutions adaptées à vos besoins</h1>
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            <div className="space-y-4 md:space-y-6">
              ...
              <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold text-primary">Besoin d'une intervention ou d'un devis ?</h2>
              ...
              <ul className="space-y-3 md:space-y-4">
                <li className="flex items-center">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center mr-3 shrink-0">
                    <Clock size={isMobile ? 16 : 20} strokeWidth={1.5} />
                  </div>
                  <span className="text-base md:text-lg">Intervention rapide garantie : 45 min Yvelines • 1h Paris</span>
                </li>
                <li className="flex items-center">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center mr-3 shrink-0">
                    <Award size={isMobile ? 16 : 20} strokeWidth={1.5} />
                  </div>
                  <span className="text-base md:text-lg">Techniciens certifiés RGE et QualiPAC</span>
                </li>
                <li className="flex items-center">
                  <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center mr-3 shrink-0">
                    <Shield size={isMobile ? 16 : 20} strokeWidth={1.5} />
                  </div>
                  <span className="text-base md:text-lg">Service client noté ★ 4.9/5 sur Google</span>
                </li>
              </ul>
            </div>
            
            <div className="bg-white p-5 md:p-8 lg:p-10 rounded-xl shadow-lg border border-gray-100 relative">
              ...
              <div className="relative">
                <h3 className="text-xl md:text-2xl font-bold text-gray-800 mb-6 md:mb-8">Comment pouvons-nous vous aider ?</h3>
                
                <div className="space-y-4 md:space-y-6">
                  <div className="p-4 md:p-6 border border-gray-100 rounded-lg hover:border-primary transition-all duration-300 group">
                    <div className="flex items-start gap-3 md:gap-4">
                      <div className="p-2 md:p-3 rounded-full bg-emergency/10 text-emergency group-hover:bg-emergency group-hover:text-white transition-all duration-300 shrink-0">
                        <Phone size={isMobile ? 20 : 24} />
                      </div>
                      <div>
                        <h4 className="font-bold text-gray-800 mb-1 text-base md:text-lg">Besoin d'une intervention urgente ?</h4>
                        <p className="text-gray-600 mb-3 md:mb-4 text-sm md:text-base">Notre équipe est disponible 24/7 pour toutes vos urgences</p>
                        <a href="tel:0185500284" className="btn-emergency inline-flex text-sm md:text-base">
                          <Phone size={isMobile ? 16 : 20} className="mr-2" />
                          Appel d'urgence
                        </a>
                      </div>
                    </div>
                  ...
                  <div className="p-4 md:p-6 border border-gray-100 rounded-lg hover:border-primary transition-all duration-300 group">
                    <div className="flex items-start gap-3 md:gap-4">
                      <div className="p-2 md:p-3 rounded-full bg-primary/10 text-primary group-hover:bg-primary group-hover:text-white transition-all duration-300 shrink-0">
                        <Mail size={isMobile ? 20 : 24} />
                      </div>
                      <div>
                        <h4 className="text-base md:text-lg font-bold text-gray-800 mb-1">Besoin d'un devis ou d'informations ?</h4>
                        <p className="text-gray-600 mb-3 md:mb-4 text-sm md:text-base">Contactez-nous pour une réponse sous 24h</p>
                        <Link to="/contact" className="btn-primary inline-flex text-sm md:text-base">
                          <Mail size={isMobile ? 16 : 20} className="mr-2" />
                          Nous contacter
                        </Link>
                      </div>
                    </div>
