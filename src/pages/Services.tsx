...
const Services = () => {
  ...
  return <>
      <SEOHead title="Services de réfrigération et climatisation - LeFrigoriste.fr" description="Découvrez nos services : dépannage frigorifique 24h/24, installation climatisation, maintenance préventive, équipements de cuisines professionnelles. Intervention rapide en Île-de-France. Devis gratuit." keywords="services frigoriste, dépannage frigorifique, installation climatisation, maintenance froid, réparation chambre froide, contrat entretien, équipements cuisine professionnelle" canonicalUrl="https://lefrigoriste.fr/services" />
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative rounded-xl overflow-hidden shadow-2xl bg-gray-900">
                <div className="aspect-video relative">
                  <div ref={playerRef} className="absolute inset-0 w-full h-full" style={{
                  ...
                  <div className="absolute inset-0 cursor-pointer z-10" onClick={togglePlay}>
                    ...
                    {!isPlaying && <div className="absolute inset-0 flex items-center justify-center bg-black bg-opacity-30 transition-opacity duration-300 hover:bg-opacity-40">
