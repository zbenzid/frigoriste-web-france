...
const Index = () => {
  return <div className="min-h-screen">
      ...
      {/* Contact CTA Section with Team Images */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div className="inline-block px-4 py-1 rounded-full bg-blue-50 text-primary font-medium text-sm">
            ...
            <div className="relative">
              <div className="bg-white p-10 rounded-xl shadow-lg border border-gray-100 relative z-10">
