...
const Testimonials = () => {
  ...
  return <section className="py-16 md:py-24 bg-gradient-to-b from-white via-gray-50/50 to-blue-50/20 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10 px-[16px]">
        ...
        {/* Citation Google Reviews - Updated to remove background on mobile */}
        <div className="mt-12 text-center">
          <div className="inline-flex flex-col md:flex-row items-center bg-transparent md:bg-white px-6 py-3 rounded-full shadow-sm">
